...
<head> 
  ...
  <script>
	...
	// 수가관리 화면으로 이동 
	function fn_moveMedicalCharge(){
		window.location.href = "medicalChargeView.do";
	}
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Medical Charge">
          <a class="nav-link" href="javascript:fn_moveMedicalCharge();">
            <i class="fa fa-fw fa-area-chart"></i>
            <span class="nav-link-text">수가 관리</span>
          </a>
        </li>
